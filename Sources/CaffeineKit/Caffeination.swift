...
class Caffeination {
    ...
    */
    func closure<Param, Ret>(_ sourceClosure: @escaping (_ parameter: Param) -> Ret) throws -> (Param) -> Ret {
     ...
     */
    static func closure<Param, Ret>(_ opts: [Opt] = [.idle, .display], sourceClosure: @escaping (_ parameter: Param) -> Ret) throws -> (Param) -> Ret {
    ...
    /**
     ...
     - Returns: A closure that will create an active Caffeination for the duration of its synchronous execution.
    */
    static func unsafeClosure<Param, Ret>(_ opts: [Opt] = [.idle, .display], sourceClosure: @escaping (_ parameter: Param) -> Ret) -> (Param) -> Ret {
        var proc: Process?
        if caffeinateExists {
